...
import { Code2, Eye, X, Loader2 } from "lucide-react";
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-xs text-muted border-b border-border">
                  <th className="text-left py-3 font-medium">Problem</th>
              ...
              <tbody>
                {submissions.map((sub) => (
                  ...
                  >
                    <td className="py-4 font-medium">{sub.problem}</td>
                    <td className="py-4">
                      <Badge variant={sub.status}>
                        {sub.status.replace(/_/g, " ")}
                      </Badge>
                    </td>
                    <td className="py-4 text-muted hidden sm:table-cell">
                      {sub.language}
                    </td>
                    <td className="py-4 text-right text-muted hidden sm:table-cell">
                      {sub.runtime}
                    </td>
